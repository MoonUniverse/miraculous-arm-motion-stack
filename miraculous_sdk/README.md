...
用户代码
  ...
  v
libmiraculous_sdk (libmiraculous_sdk.so / .a)
  ├── CAN 传输层        — SocketCAN 封装 (can_socket.c)
  ├── CANopen 主站层    — NMT/SDO/PDO/SYNC/EMCY/Heartbeat
  └── CiA402 运动控制层 — PDS 状态机 + PP/PV/PT/CSP/CSV/CST/MIT
```
